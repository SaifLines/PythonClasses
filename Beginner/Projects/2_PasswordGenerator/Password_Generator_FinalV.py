...
# 1 point if it contains at least one sign (?.;!@#$%&*"') 
...
def the_password():
    ...
    if change == 'y' or change == "yes":
        n_passwords = int(input("how many passwords? please enter a number from 1 to 100: "))
        ...
        while i<=n_passwords:
            ...
            passwords_list.append(new_pass)
            i +=1 
